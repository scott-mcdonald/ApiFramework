...
namespace ApiFramework.Collections
{
    /// <summary>
    /// Represents an ordered read-only dictionary.
    /// </summary>
    /// <remarks>
    /// This read-only dictionary is ordered meaning it preserves the order in which the key/value pairs were passed upon construction.
    /// </remarks>
    ...
    public class OrderedReadOnlyDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>
    {
        ...
        public int Count => this.ReadOnlyList.Count;
        #endregion
        ...
        // PUBLIC FIELDS ////////////////////////////////////////////////////
        #region Fields
        public static readonly OrderedReadOnlyDictionary<TKey, TValue> Empty = new OrderedReadOnlyDictionary<TKey, TValue>(null, null);
        #endregion
