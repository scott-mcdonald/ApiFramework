...
namespace ApiFramework.Reflection
{
    ...
    public static class TypeReflection
    {
        ...
        public static FieldInfo GetField(Type type, string fieldName)
        {
            ...
            return GetFields(type.GetTypeInfo(), fieldName, DefaultFieldBindingFlags).SingleOrDefault();
        }
        ...
        public static IEnumerable<FieldInfo> GetFields(Type type)
        {
            ...
            return GetFields(type.GetTypeInfo(), null, DefaultFieldBindingFlags);
        }

        public static IEnumerable<FieldInfo> GetFields(Type type, ReflectionFlags reflectionFlags)
        {
            Contract.Requires(type != null);
        ...
        /// </summary>
        /// <remarks>
        /// Can be used by the static method Type.GetType(string) to create <c>Type</c> objects from strings.
        /// </remarks>
        ...
        public static bool IsEnumerableOfT(Type type, out Type enumerableType)
        {
            ...
            {
                enumerableType = typeInfo.GenericTypeParameters.First();
                return true;
            }

            if (typeInfo.IsGenericType && typeInfo.GetGenericTypeDefinition() == typeof(IEnumerable<>))
            {
                enumerableType = typeInfo.GenericTypeArguments.First();
                return true;
            }
            ...
            if (enumerableGenericTypeArgumentsCount > 1)
                throw new ArgumentException($"CLR type [name={type.Name}] implements multiple versions of IEnumerable<T>.");
        ...
        public static bool IsSimple(Type type)
        {
            ...
            {
                var nullableUnderlyingType = Nullable.GetUnderlyingType(type);
                return IsSimple(nullableUnderlyingType);
            }
            ...
            if (IsEnum(type))
            {
                ...
                return IsSimple(enumUnderlyingType);
            }
        ...
        private static IEnumerable<FieldInfo> FilterOnPublicAndNonPublic(IEnumerable<FieldInfo> query, ReflectionFlags reflectionFlags)
        {
            var isPublic    = reflectionFlags.HasFlag(ReflectionFlags.Public);
            var isNonPublic = reflectionFlags.HasFlag(ReflectionFlags.NonPublic);
        ...
        {
            Contract.Requires(assemblyQualifiedName.SafeHasContent());
        ...
        private static void ValidateInstanceAndStaticBindingFlags(bool isInstance, bool isStatic)
        {
            ...
            var message          = $"{bindingFlagsName} must at least specify either {ReflectionFlags.Instance} or {ReflectionFlags.Static}";
        ...
        private static void ValidatePublicAndNonPublicBindingFlags(bool isPublic, bool isNonPublic)
        {
            ...
            var bindingFlagsName = typeof(ReflectionFlags).Name;
            var message          = $"{bindingFlagsName} must at least specify either {ReflectionFlags.Public} or {ReflectionFlags.NonPublic}";
        ...
        private const ReflectionFlags DefaultFieldBindingFlags =
