...
{
    /// <summary>
    /// Represents a single attribute of a node attribute collection where the concept of an attribute represents a named value.
    /// </summary>
    /// <remarks>
    /// Attribute values should never be null and if they are, do not add the attribute to represent the attribute is not defined.
    /// This class assumes attribute values are never null.
    /// </remarks>
    public abstract class NodeAttribute
    {
        ...
        {
            var message = $"{this.Name} attribute has already been added to a node.";
