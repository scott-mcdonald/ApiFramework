...
namespace ApiFramework.Schema.Configuration.Internal
{
    ...
    /// </summary>
    internal class ClrRelationshipProperty
    {
        // PUBLIC CONSTRUCTORS //////////////////////////////////////////////
        #region Constructors
        public ClrRelationshipProperty(string clrPropertyName, Type clrPropertyType)
        {
        ...
        {
            return $"{nameof(ClrRelationshipProperty)} [{nameof(this.ClrPropertyName)}={this.ClrPropertyName}]";
        }
        #endregion
    }
}