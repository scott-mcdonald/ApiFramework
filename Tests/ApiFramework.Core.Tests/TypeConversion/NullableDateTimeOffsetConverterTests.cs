...
namespace ApiFramework.TypeConversion
{
    public class NullableDateTimeOffsetConverterTests : ConverterTests
    {
        ...
        public void TestConveterConvertGeneric(IXUnitTest unitTest)
        {
        ...
        public void TestConveterTryConvertGeneric(IXUnitTest unitTest)
        {
            unitTest.Execute(this);
            this.WriteBuffer();
        }
        ...
        public static readonly IEnumerable<object[]> ConvertGenericTestData = new[]
            {
                new object[]
                    {
                        new XUnitTestAggregate("Nullable<DateTimeOffset>ToXXX",
                            // Simple Types
