...
namespace ApiFramework.TypeConversion
{
    public abstract class ConverterTests : XUnitTests
    {
        ...
        public class ConvertGenericTest<TSource, TTarget> : XUnitTest
        {
            // PUBLIC CONSTRUCTORS //////////////////////////////////////////
            #region Constructors
            ...
            private TypeConverterSettings Context { get; set; }
            #endregion
        ...
        public class TryConvertGenericTest<TSource, TTarget> : XUnitTest
        {
            // PUBLIC CONSTRUCTORS //////////////////////////////////////////
            #region Constructors
            public TryConvertGenericTest(string name, TSource source, ConvertResult expectedResult, TTarget expectedValue, TypeConverterSettings context = null)
                : base(name)
            {
                this.Source = source;
                this.ExpectedResult = expectedResult;
        ...
        public static readonly TypeConverterSettings FormatDateTimeContext = new TypeConverterSettings
        {
            Format = FullDateTimeFormat,
            DateTimeStyles = DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal
        };

        public static readonly TypeConverterSettings FormatAndFormatProviderDateTimeContext = new TypeConverterSettings
        {
            Format = FullDateTimeFormat,
        ...
        public static readonly TypeConverterSettings FormatDateTimeOffsetContext = new TypeConverterSettings
        {
            Format = FullDateTimeFormat,
            DateTimeStyles = DateTimeStyles.AssumeUniversal
        };

        public static readonly TypeConverterSettings FormatAndFormatProviderDateTimeOffsetContext = new TypeConverterSettings
        {
            Format = FullDateTimeFormat,
            FormatProvider = SpanishMexicoCulture,
            DateTimeStyles = DateTimeStyles.AssumeUniversal
        ...
        public static readonly TypeConverterSettings FormatTimeSpanContext = new TypeConverterSettings
        {
            Format = GeneralShortTimeSpanFormat
        };

        public static readonly TypeConverterSettings FormatAndFormatProviderTimeSpanContext = new TypeConverterSettings
        {
            Format = GeneralShortTimeSpanFormat,
        ...
        public static readonly TypeConverterSettings FormatEnumContext = new TypeConverterSettings
        {
