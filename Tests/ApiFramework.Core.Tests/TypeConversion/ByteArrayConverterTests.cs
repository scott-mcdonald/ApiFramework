...
namespace ApiFramework.TypeConversion
{
    public class ByteArrayConverterTests : ConverterTests
    {
        ...
        public void TestTypeConveterConvertGeneric(IXUnitTest unitTest)
        {
        ...
        public void TestTypeConveterTryConvertGeneric(IXUnitTest unitTest)
        {
            unitTest.Execute(this);
            this.WriteBuffer();
        }
        ...
        public static readonly IEnumerable<object[]> ConvertGenericTestData = new[]
            {
                new object[]
                    {
                        new XUnitTestAggregate("ByteArrayToXXX",
                            // Simple Types
