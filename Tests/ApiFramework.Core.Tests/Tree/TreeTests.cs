...
namespace ApiFramework.Tree
{
    public class TreeTests : XUnitTests
    {
        ...
        public void TestTreeAddNodeWith1MaxDepth()
        {
            ...
            // Act
            var tree = BuildTree(maxDepth, maxChildren, out var nodeDictionary);
            this.WriteLine();
            this.WriteLine("ApiDocumentTree");
        ...
        public void TestTreeRemoveNode11With2MaxDepthAnd1MaxChildren()
        {
            ...
            var tree = BuildTree(maxDepth, maxChildren, out var nodeDictionary);
            this.WriteLine();
            this.WriteLine("ApiDocumentTree Before RemoveNode");
            this.WriteLine(tree.ToTreeString());
            ...
            this.WriteLine();
            this.WriteLine("ApiDocumentTree After RemoveNode");
            this.WriteLine(tree.ToTreeString());
        ...
        public void TestTreeReplaceNode11With2MaxDepthAnd1MaxChildren()
        {
            ...
            var tree = BuildTree(maxDepth, maxChildren, out var nodeDictionary);
            this.WriteLine();
            this.WriteLine("ApiDocumentTree Before ReplaceNode");
            this.WriteLine(tree.ToTreeString());
            ...
            var newNode11 = new TestNode("NEW 1-1");

            node1.ReplaceNode(oldNode11, newNode11);

            this.WriteLine();
            this.WriteLine("ApiDocumentTree After ReplaceNode");
            this.WriteLine(tree.ToTreeString());
        ...
        public void TestTreeReplaceNode12With2MaxDepthAnd2MaxChildren()
        {
            ...
            var newNode12 = new TestNode("NEW 1-2");
        ...
        public void TestTreeReplaceNode13With2MaxDepthAnd3MaxChildren()
        {
            ...
            var newNode13 = new TestNode("NEW 1-3");
        ...
        public void TestTreeReplaceNode14With2MaxDepthAnd4MaxChildren()
        {
            ...
            var newNode14 = new TestNode("NEW 1-4");
        ...
        public void TestTreeAttributes(string name, int attributeCount)
        {
            ...
            BuildAttributes(attributeCount, tree, out var nodeAttributeDictionary);
        ...
        [Theory]
        [MemberData(nameof(TestTreeChildNodesTestData))]
        public void TestTreeChildNodes(string name, int maxDepth, int maxChildren)
        {
            // Arrange
            this.WriteLine("Test Name: {0}", name);
            this.WriteLine();
        ...
        [Theory]
        [MemberData(nameof(TestTreeChildNodesTestData))]
        public void TestTreeChildNodesIncludeSelf(string name, int maxDepth, int maxChildren)
        {
            // Arrange
            this.WriteLine("Test Name: {0}", name);
            this.WriteLine();
            ...
            var actual = tree.ChildNodesIncludeSelf()
                             .Select(x => x.Name)
                             .ToList();
            var actualAsString = String.Join(" ", actual);
            this.WriteLine();
        ...
        [Theory]
        [MemberData(nameof(TestTreeParentNodesTestData))]
        public void TestTreeParentNodes(string name, int maxDepth, int maxChildren)
        {
            // Arrange
            this.WriteLine("Test Name: {0}", name);
            this.WriteLine();
            ...
            // Act
            var tree = BuildTree(maxDepth, maxChildren, out var nodeDictionary);
            var lastChildNode = nodeDictionary.Values
            ...
            this.WriteLine(tree.ToTreeString());
            this.WriteLine();
            this.WriteLine("Nodes from   = {0}", lastChildNode.Name);

            var expectedParentNodes = new List<TestNode>();
            var currentParentNode   = lastChildNode.ParentNode;
            while (currentParentNode != null)
            {
                expectedParentNodes.Add(currentParentNode);
                currentParentNode = currentParentNode.ParentNode;
            }

            var expected = expectedParentNodes.Select(x => x.Name)
                                              .ToList();
            var expectedAsString = String.Join(" ", expected);
            this.WriteLine();
            this.WriteLine("Expected     = {0}", expectedAsString);

            var actual = lastChildNode.ParentNodes()
                                      .Select(x => x.Name)
                                      .ToList();
            var actualAsString = String.Join(" ", actual);
            this.WriteLine();
        ...
        [Theory]
        [MemberData(nameof(TestTreeParentNodesTestData))]
        public void TestTreeParentNodesIncludeSelf(string name, int maxDepth, int maxChildren)
        {
            // Arrange
            this.WriteLine("Test Name: {0}", name);
            this.WriteLine();
            ...
            var actual = lastChildNode.ParentNodesIncludeSelf()
                                      .Select(x => x.Name)
                                      .ToList();
            var actualAsString = String.Join(" ", actual);
            this.WriteLine();
        ...
        public void TestTreeRemoveNodeAttribute1With1AttributeCount()
        {
            ...
            BuildAttributes(attributeCount, tree, out var nodeAttributeDictionary);
            this.WriteLine();
            this.WriteLine("ApiDocumentTree Before RemoveAttribute");
            this.WriteLine(tree.ToTreeString());
            ...
            this.WriteLine();
            this.WriteLine("ApiDocumentTree After RemoveAttribute");
            this.WriteLine(tree.ToTreeString());
        ...
        public void TestTreeReplaceNodeAttribute1With1AttributeCount()
        {
            ...
            BuildAttributes(attributeCount, tree, out var nodeAttributeDictionary);
            this.WriteLine();
            this.WriteLine("ApiDocumentTree Before ReplaceAttribute");
            this.WriteLine(tree.ToTreeString());
            ...
            this.WriteLine();
            this.WriteLine("ApiDocumentTree After ReplaceAttribute");
            this.WriteLine(tree.ToTreeString());
        ...
        public static readonly IEnumerable<object[]> TestTreeChildNodesTestData = new[]
                                                                                  {
                                                                                      ...
                                                                                      new object[] {"With4MaxDepthAnd1MaxChildren", 4, 1},
                                                                                      new object[] {"With4MaxDepthAnd2MaxChildren", 4, 2},
                                                                                      new object[] {"With4MaxDepthAnd3MaxChildren", 4, 3},
                                                                                      new object[] {"With4MaxDepthAnd4MaxChildren", 4, 4},
                                                                                  };
        ...
        public static readonly IEnumerable<object[]> TestTreeParentNodesTestData = new[]
                                                                                   {
                                                                                       new object[] {"With1MaxDepth", 1, 0},
        ...
        // PRIVATE METHODS //////////////////////////////////////////////////
        #region Test Methods
        private static void BuildAttributes(int attributeCount, TestNode node, out IDictionary<string, NodeAttribute> nodeAttributeDictionary)
        {
        ...
        private static TestNode BuildTree(int maxDepth, int maxChildren, out IDictionary<string, TestNode> nodeDictionary)
        {
            nodeDictionary = new Dictionary<string, TestNode>();

            if (maxDepth == 0)
                return null;

            var rootNode = new TestNode("1");
        ...
        private static void BuildTree(int maxDepth, int maxChildren, int currentDepth, TestNode parentNode, IDictionary<string, TestNode> nodeDictionary)
        {
            // Create child nodes
        ...
        // PRIVATE TYPES ////////////////////////////////////////////////////
        #region Types
        private class TestNode : Node<TestNode>
        {
            #region Constructors
            public TestNode(string name, params TestNode[] nodes)
                : base(name, nodes)
            {
            }
            #endregion
