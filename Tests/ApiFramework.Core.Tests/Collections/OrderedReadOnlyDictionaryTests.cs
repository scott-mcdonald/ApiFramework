...
namespace ApiFramework.Collections
{
    public class OrderedReadOnlyDictionaryTests : XUnitTests
    {
        ...
        public void TestOrderedReadOnlyDictionaryCreation(IXUnitTest unitTest)
        { unitTest.Execute(this); }
        #endregion

        // PRIVATE FIELDS ///////////////////////////////////////////////////
        #region Test Data
        private static IEnumerable<KeyValuePair<Guid, Guid>> CreateGuidToGuidCollection(int count)
        {
        ...
        // PRIVATE TYPES ////////////////////////////////////////////////////
        #region Test Types
        private class OrderedReadOnlyDictionaryUnitTest<TKey, TValue> : XUnitTest
        {
            // PUBLIC CONSTRUCTORS //////////////////////////////////////////
            #region Constructors
